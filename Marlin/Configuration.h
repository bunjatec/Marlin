...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.20,  22.20,  22.20 }
    #define DEFAULT_Ki_LIST {   1.08,   1.08,   1.08 }
    #define DEFAULT_Kd_LIST { 114.00, 114.00, 114.00 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 523.255, 523.255, 523.255 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      {  1500, 1500, 100, 100,100,100 }
